...
Triangle::Triangle(): Shape{}, a_{0.0f, 0.0f, 0.0f}, b_{0.0f, 0.0f, 0.0f}, c_{0.0f, 0.0f, 0.0f}{}
Triangle::Triangle(glm::vec3 const& a, glm::vec3 const& b, glm::vec3 const& c): Shape{}, a_{a}, b_{b}, c_{c}{}
Triangle::Triangle(std::string name, glm::vec3 const& a, glm::vec3 const& b, glm::vec3 const& c, std::string material) : Shape{name, material}, a_{a}, b_{b}, c_{c}{}
