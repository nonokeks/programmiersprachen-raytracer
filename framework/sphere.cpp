...
//Sphere(glm::vec3 const& center, float radius, std::string name, Material const& mat):Shape{name, mat}, center_{center}, radius_{radius} {}
//Sphere(glm::vec3 const& center, float radius, std::string name, std::string name_mat, Color const& ka, Color const& kd, Color const& ks, 
