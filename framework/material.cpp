...
Material::Material(std::string name, Color const& ka, Color const& kd, Color const& ks, float m, float refract, float opacity):
	name_{name},
	ka_{ka},
	kd_{kd},
	ks_{ks},
...
std::ostream& operator<<(std::ostream& os, Material const& mat){
	os << "Material name: " << mat.name_ << " ka: " << mat.ka_.r << " " << mat.ka_.g << " " << mat.ka_.b << "\n";
